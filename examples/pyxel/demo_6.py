...
class App:
    def __init__(self):
        ...
        add_event_listener(js.window, "blur", self.pause)
        add_event_listener(js.window, "focus", self.resume)
    ...
    def draw(self):
        ...
        for bubble in self.bubbles:
            if self.paused:
                pyxel.circ(bubble.pos.x, bubble.pos.y, bubble.r, 13)
                pyxel.circ(bubble.pos.x, bubble.pos.y, bubble.r-1, 0)
            else:
