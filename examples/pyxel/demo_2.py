...
scoreElement = js.document.getElementById("score")
playerX = js.document.getElementById("x")
playerY = js.document.getElementById("y")
fruits = js.document.getElementById("fruits")
pauseEl = js.document.getElementById("pause")
highScoreEl = js.document.getElementById("highscore")
...
class App:
    def __init__(self):
        ...
        self.paused = False
        add_event_listener(pauseEl, "click", self.flipPaused)

        js.document.getElementById("sidebar").classList.remove("hidden")
    ...
    def draw(self):
        ...
        if self.score > self.high_score:
            ...
            highScoreEl.innerText = self.score

        scoreElement.innerText=self.score
        playerX.innerText=self.player_x
        playerY.innerText=self.player_y
        fruits.innerText = len(self.fruit)
